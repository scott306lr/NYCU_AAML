                    ...
                    for (int filter_y = 0; filter_y < filter_height; ++filter_y) {
                        ...
                        for (int filter_x = 0; filter_x < filter_width; ++filter_x) {
                            ...
                            for (int in_channel = 0; in_channel < input_depth; in_channel += 4) {
                                ...
                                if (depth_limit == 4) {  // if the remaining depth is 4, we can use one single operation for all
                                    ...
                                    for (int d = 0; d < depth_limit; d++) {
                                        input_val |= (static_cast<int32_t>(input_ptr[d]) & 0xFF) << (8 * d);
                                        filter_val |= (static_cast<int32_t>(filter_ptr[d]) & 0xFF) << (8 * d);
                                    }
                                }
