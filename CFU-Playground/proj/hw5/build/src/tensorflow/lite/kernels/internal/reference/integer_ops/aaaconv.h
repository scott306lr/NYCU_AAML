...
inline void ConvPerChannel(
    ...
    int8_t input_matrix[int(1e6)];
    int8_t weight_matrix[int(1e6)];
                    ...
                    for (int filter_y = 0; filter_y < filter_height; ++filter_y) {
                        ...
                        for (int filter_x = 0; filter_x < filter_width; ++filter_x) {
                            ...
                            for (int in_channel = 0; in_channel < filter_input_depth; ++in_channel) {
                                ...
                                input_matrix[Offset(input_shape, batch, in_y, in_x,
                                                    in_channel + group * filter_input_depth)] = input_val;
                                weight_matrix[Offset(filter_shape, out_channel, filter_y, filter_x, in_channel)] = filter_val;
                            }
