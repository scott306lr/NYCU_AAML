...
void do_classify_cat() {
    print_result(classify_cat());
}
...
void do_classify_diagram() {
    print_result(classify_diagram());
}
...
void do_classify_hps_0() {
    print_result(classify_hps_0());
}
...
void do_classify_hps_1() {
    print_result(classify_hps_1());
}
...
void do_classify_hps_2() {
    print_result(classify_hps_2());
}
...
struct Menu MENU = {
    ...
    "hps",
    {
        ...
        MENU_ITEM('g', "Golden tests (check for expected outputs)", do_golden_tests),
        MENU_ITEM('0', "Reinitialize with 09_20 model", do_init_09_20),
        MENU_ITEM('1', "Reinitialize with 01_05_74ops model", do_init_01_05_74ops),
        MENU_ITEM('2', "Reinitialize with 01_05_89ops model", do_init_01_05_89ops),
        MENU_ITEM('3', "Reinitialize with presence_2022017_96ops model", do_init_presence_2022017_96ops),
        MENU_ITEM('4', "Reinitialize with second_2022017_96ops model", do_init_second_2022017_96ops),
        MENU_ITEM('5', "Reinitialize with presence_20220415_96ops model", do_init_presence_20220415_96ops),
        MENU_ITEM('6', "Reinitialize with second_20220416_96ops model", do_init_second_20220416_96ops),
        MENU_ITEM('7', "Reinitialize with shared_20220623_1032_tiled model", do_init_shared_20220623_1032_tiled),
        MENU_END,
    },
};
